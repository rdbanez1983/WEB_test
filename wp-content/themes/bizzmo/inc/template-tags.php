...
if ( ! function_exists( 'bizzmo_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function bizzmo_posted_on() {
...
if ( ! function_exists( 'bizzmo_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function bizzmo_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html( '%s', 'post author', 'bizzmo' ),
...
if ( ! function_exists( 'bizzmo_post_comments' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time and author.
	 */
	function bizzmo_post_comments() {
...
if ( ! function_exists( 'bizzmo_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function bizzmo_entry_footer() {
...
if ( ! function_exists( 'bizzmo_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function bizzmo_post_thumbnail() {
...
if( ! function_exists( 'bizzmo_fontawesome_social_icons_lists' ) ) :
	/**
     * Font Awesome
     *
	...
	function bizzmo_fontawesome_social_icons_lists() {
